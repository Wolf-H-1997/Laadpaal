...
def main():
    ...
    if choice == "Clusteren":
        ...
        st.markdown("#  Allereerst worden de kolommen van interesse geselecteerd uit de dataset, waaronder 'ChargingPeriod', 'Start Time' en '3PhaseActivePowW'. De 'Start Time' wordt ingesteld als de index van de geselecteerde data. Vervolgens wordt een constante waarde toegevoegd aan de '3PhaseActivePowW' kolom om negatieve waarden te voorkomen, en de data wordt gelogaritmeerd met behulp van de logaritmische functie. Daarna wordt de data geschaald met behulp van de StandardScaler om ervoor te zorgen dat alle variabelen vergelijkbare schalen hebben.
